...
const Step2_SelecionarProdutos: React.FC<Step2Props> = ({
    ...
    const isProdutoJaSelecionado = (produtoId: number) => {
        return produtosSelecionados.some((p) => p.product_id === produtoId)
    }
    ...
    if (loading) {
        return (
            <div className="p-4">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Selecionar Produtos</h2>
        ...
        <div className="p-4">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                <input
                    ...
                    className="p-2 border border-gray-300 rounded text-sm flex-1 min-w-[150px] focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                />
                <select
                            ...
                            return (
                                ...
                                >
                                    <div className="flex flex-col h-full">
                                        <h4 className="text-base font-medium text-gray-800 mb-2 line-clamp-2">{produto.name}</h4>
                                        <p className="text-sm text-gray-600 mb-1">{produto.product_type}</p>
                                        {produto.description && (
